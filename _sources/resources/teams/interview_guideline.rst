...
See 6.1 of the OnStage rules and the OnStage Score Sheets for the Technical Interview.

Before the Interview: Know Your Story
-------------------------------------
...
During the Interview: Share Your Story
--------------------------------------
...
*What judges are looking for:*
They want to know if the team understands how the robot was developed and works as a system, not just individual parts.
...
*What judges are looking for:* 
They want to see learning during the process,  both technical and personal!
...
Live Demonstration of Selected Features during the Interview
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
